...
function nameShuffle(str) {
  ...
  return splitOnSpace[1] + ", " + splitOnSpace[0];
}
...
function isStrangePair(str1, str2) {
  var firstCharStr2 = str2.charAt(0);
  var lastCharStr1 = str1.charAt(str1.length - 1);
...
function convertToDecimal(percent) {
  decimalPercent = parseFloat(percent) / 100;
...
function checkSameSum(a1, a2) {
  const sum1 = a1.reduce(function (a, b) {
    return a + b;
  }, 0);
  const sum2 = a2.reduce(function (a, b) {
    return a + b;
  }, 0);
